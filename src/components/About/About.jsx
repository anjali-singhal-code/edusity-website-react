  ...
  return (
    <div className='about'>
      ...
      <div className="about-right">
        ...
        <p>With a focus on innovation, hands-on learning, and personalized mentoship, our programs prepare aspiring educators to make a meaningful inpact in classrooms, schools, and communities.</p>
